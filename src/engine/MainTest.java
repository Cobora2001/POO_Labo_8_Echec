...
public class MainTest {
    public static void main(String[] args) {
        try {
            ...
            controller.move(3, 1, 3, 3); // avancer Queen WHITE: Échec - Résultat attendu
            controller.move(3, 1, 4, 2);
            controller.move(3, 5, 3, 4); // avancer Queen BLACK: OK
            controller.move(4, 2, 2, 4); // avancer Queen WHITE: OK
            ...
            controller.move(5, 1, 2, 1); // avancer Rook BLACK:  OK - Mise en échec
